...
public class Page_desserts extends JFrame {
    ...
    public Page_desserts(int numberOfRestaurant)
    {
        
        frame_desserts.setTitle("Talabat Clone");
        frame_desserts.setSize(450,750); //450,780
        frame_desserts.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
        frame_desserts.setResizable(false);
        frame_desserts.setLocation(550,150);
        ...
        // First Meal
        image1 =new JLabel();
        String s=res.restaurant[numberOfRestaurant].pictures_desserts[1];
        image1.setIcon(new ImageIcon(jf.class.getResource(s)));
        image1.setBounds(280, 300, 140, 80);
        panel1.add(image1);
        
        meal1 =new JLabel(res.restaurant[numberOfRestaurant].desserts[1]);
        meal1.setBounds(15, 300, 200, 60);
        meal1.setFont(new Font("sansserif",Font.BOLD, 15));
        meal1.setForeground(Color.BLACK);
        
        Price_meal1 =new JLabel("EGP "+res.restaurant[numberOfRestaurant].desserts_Price[1]);
        ...
        // Second Meal
        image2 =new JLabel();
        s=res.restaurant[numberOfRestaurant].pictures_desserts[2];
        image2.setIcon(new ImageIcon(jf.class.getResource(s)));
        image2.setBounds(280, 400, 140, 80);
        panel1.add(image2);
        
        meal2 =new JLabel(res.restaurant[numberOfRestaurant].desserts[2]);
        meal2.setBounds(15, 390, 250, 60);
        meal2.setFont(new Font("sansserif",Font.BOLD, 15));
        meal2.setForeground(Color.BLACK);
        
        Price_meal2 =new JLabel("EGP "+res.restaurant[numberOfRestaurant].desserts_Price[2]);
        ...
        // Third Meal
        image3 =new JLabel();
        s=res.restaurant[numberOfRestaurant].pictures_desserts[3];
        image3.setIcon(new ImageIcon(jf.class.getResource(s)));
        image3.setBounds(280, 510, 140, 80);
        panel1.add(image3);
        
        meal3 =new JLabel(res.restaurant[numberOfRestaurant].desserts[3]);
        meal3.setBounds(15, 510, 200, 40);
        meal3.setFont(new Font("sansserif",Font.BOLD, 15));
        meal3.setForeground(Color.BLACK);
        
        Price_meal3 =new JLabel("EGP "+res.restaurant[numberOfRestaurant].desserts_Price[3]);
        ...
        // Forth Meal
        image4 =new JLabel();
        s=res.restaurant[numberOfRestaurant].pictures_desserts[4];
        image4.setIcon(new ImageIcon(jf.class.getResource(s)));
        image4.setBounds(280, 620, 140, 80);
        panel1.add(image4);
        
        meal4 =new JLabel(res.restaurant[numberOfRestaurant].desserts[4]);
        meal4.setBounds(15, 610, 200, 40);
        meal4.setFont(new Font("sansserif",Font.BOLD,15));
        meal4.setForeground(Color.BLACK);
        
        Price_meal4 =new JLabel("EGP "+res.restaurant[numberOfRestaurant].desserts_Price[4]);
        ...
        frame_desserts.setLayout(null);
        frame_desserts.setVisible(true);
    ...
    public class mouse_Listener implements MouseListener,MouseWheelListener,MouseMotionListener
    {
        ...
        public void mouseClicked(MouseEvent me) {
            ...
            else if(me.getSource()==meals)
            {
                ...
                frame_desserts.setVisible(false);
            }
